...
public final class InvalidCredentialsException extends DomainException {
  ...
  private static final String MSG_INACTIVE_ACCOUNT = "Tu cuenta no está activa. Contacta al administrador.";
  ...
  public static InvalidCredentialsException becauseUserIsNotActive() {
    return new InvalidCredentialsException(MSG_INACTIVE_ACCOUNT);
  }
}
