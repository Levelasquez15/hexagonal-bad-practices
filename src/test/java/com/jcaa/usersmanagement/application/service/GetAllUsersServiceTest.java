 ...
 *
 * <p>Covers: happy path returning a list of users, and returning an empty list when no users exist.
 */
@DisplayName("Get All Users Service Tests")
...
class GetAllUsersServiceTest {
  ...
  @Test
  @DisplayName("Should return a list of users when users exist in the port")
